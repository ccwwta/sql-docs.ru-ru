...
Столбец таблицы в [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] можно переименовать, используя [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] или [!INCLUDE[tsql](../../includes/tsql-md.md)].
