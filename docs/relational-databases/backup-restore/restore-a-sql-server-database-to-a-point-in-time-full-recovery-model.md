---
description: Восстановление базы данных SQL Server до определенного момента времени (модель полного восстановления)
 ...
 **Основной синтаксис [!INCLUDE[tsql](../../includes/tsql-md.md)]**  
 ...
 RESTORE LOG *имя_базы_данных* FROM <устройство_резервного_копирования> WITH STOPAT **=** _time_ **,** RECOVERY...  
 ...
 Чтобы восстановить только изменения до определенного момента времени, для каждой восстанавливаемой резервной копии укажите WITH STOPAT **=** _время_. Это гарантирует, что конечное время не будет пропущено.  
