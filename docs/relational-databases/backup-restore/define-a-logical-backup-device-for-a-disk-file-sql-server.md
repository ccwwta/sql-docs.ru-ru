...
description: В этой статье показано, как определить логическое устройство резервного копирования для дискового файла в SQL Server с помощью SQL Server Management Studio или Transact-SQL.
