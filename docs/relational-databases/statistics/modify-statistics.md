...
ms.locfileid: "99250282"
---
# <a name="modify-statistics"></a>Изменение статистики
[!INCLUDE[SQL Server Azure SQL Database Synapse Analytics PDW ](../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]
  Существующую статистику в [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] можно изменить с помощью среды [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] или [!INCLUDE[tsql](../../includes/tsql-md.md)].  
