...
Вы можете использовать следующее руководство для включения флага трассировки 2371 в среде до [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)].
