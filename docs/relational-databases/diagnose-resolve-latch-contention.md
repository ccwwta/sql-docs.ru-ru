...
Если при проверке динамического административного представления *sys.dm_os_wait_stats* обнаружены кратковременные блокировки, не связанные с буфером, необходимо проверить *sys.dm_os_latch_waits*, чтобы получить подробную разбивку совокупных сведений о времени ожидания для кратковременных блокировок, не относящихся к буферу. Все ожидания кратковременной блокировки буфера классифицируются в классе кратковременной блокировки буфера, остальные используются для классификации кратковременных блокировок, не относящихся к буферу.
