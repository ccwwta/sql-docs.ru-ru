...
- **Все**: Записывает все запросы. Этот параметр используется по умолчанию в [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] и [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)].
...
В следующем примере параметр QUERY_CAPTURE_MODE устанавливается в значение AUTO и задаются остальные рекомендованные параметры в [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)]:
...
Хранилище запросов на вторичной активной геореплике Базы данных SQL Azure будет доступной только для чтения копии действия на первичной реплике. 
