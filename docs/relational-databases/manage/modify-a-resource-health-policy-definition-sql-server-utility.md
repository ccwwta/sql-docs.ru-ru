...
description: Узнайте, как использовать SQL Server Management Studio для изменения определения политики исправности ресурсов, чтобы лучше оценивать данные о производительности SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
