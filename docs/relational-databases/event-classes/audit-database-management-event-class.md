---
description: Audit Database Management, класс событий
...
|**ObjectType**|**int**|Значение, представляющее тип объекта, связанного с событием. Значение соответствует столбцу type в таблице **sysobjects** . Значения см. в разделе [Столбец события ObjectType Trace](../../relational-databases/event-classes/objecttype-trace-event-column.md).|28|Да|  
