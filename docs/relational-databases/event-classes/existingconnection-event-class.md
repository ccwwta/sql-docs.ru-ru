---
description: ExistingConnection, класс событий
...
## <a name="see-also"></a>См. также:  
 ...
 [Класс событий Audit Login](../../relational-databases/event-classes/audit-login-event-class.md)  
