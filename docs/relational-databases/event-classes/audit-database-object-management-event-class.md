---
description: Класс событий Audit Database Object Management
...
ms.locfileid: "99199931"
---
# <a name="audit-database-object-management-event-class"></a>Класс событий Audit Database Object Management
[!INCLUDE [SQL Server - ASDB](../../includes/applies-to-version/sql-asdb.md)]
   Класс событий **Database Object Management** возникает при выполнении инструкций CREATE, ALTER или DROP над объектами базы данных, например схемами.  
