---
description: Audit Database Principal Management, класс событий
...
ms.locfileid: "99187091"
---
# <a name="audit-database-principal-management-event-class"></a>Audit Database Principal Management, класс событий
[!INCLUDE [SQL Server - ASDB](../../includes/applies-to-version/sql-asdb.md)]
   Класс событий **Audit Database Principal Management** возникает, когда в базе данных создаются, изменяются или удаляются участники, например пользователи.  
