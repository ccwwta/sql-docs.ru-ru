---
description: Showplan XML, класс событий
...
[!INCLUDE [SQL Server - ASDB](../../includes/applies-to-version/sql-asdb.md)]
 ...
 Документы Showplan XML имеют схему, связанную с ними. Эта схема находится на [веб-сайте Майкрософт](/previous-versions/aa720019(v=vs.71))или является частью установки [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
