---
description: Audit Database Operation, класс событий
...
ms.locfileid: "99187101"
---
# <a name="audit-database-operation-event-class"></a>Audit Database Operation, класс событий
[!INCLUDE [SQL Server - ASDB](../../includes/applies-to-version/sql-asdb.md)]
   Класс событий **Audit Database Operation** возникает при выполнении в базе данных таких операций, как установка контрольной точки или подписка на уведомления о запросе.  
