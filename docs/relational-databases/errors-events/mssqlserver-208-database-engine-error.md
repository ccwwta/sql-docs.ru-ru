...
description: Не удается найти указанный объект, что приводит к неправильному сообщению с именем объекта. См. объяснение ошибки и возможные способы ее устранения.
ms.custom: ''
ms.date: 04/04/2017
ms.prod: sql
ms.reviewer: ''
