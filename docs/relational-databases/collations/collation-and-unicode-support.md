...
Параметры сортировки могут учитывать регистр, диакритические знаки, тип японской азбуки, ширину символов и знаки выбора варианта. В [!INCLUDE[sql-server-2019](../../includes/sssql19-md.md)] появился дополнительный параметр для кодирования [UTF-8](https://www.wikipedia.org/wiki/UTF-8). 
...
Кроме того, начиная с [!INCLUDE[sql-server-2019](../../includes/sssql19-md.md)], если используется сортировка UTF-8 (\_UTF8), то предыдущие типы данных, отличные от Юникода (**char** и **varchar**), становятся типами данных Юникода, использующими кодировку UTF-8. В [!INCLUDE[sql-server-2019](../../includes/sssql19-md.md)] не изменяется поведение ранее существовавших типов данных (**nchar**, **nvarchar** и **ntext**), которые продолжают использовать кодировку UCS-2 или UTF-16. Дополнительные сведения см. в разделе [Различия в хранении UTF-8 и UTF-16](#storage_differences).
...
Чтобы воспользоваться доступными в [!INCLUDE[sql-server-2019](../../includes/sssql19-md.md)] параметрами сортировки UTF-8 для оптимизации поиска и сортировки некоторых символов Юникода (только параметры сортировки Windows), необходимо выбрать параметры сортировки с поддержкой кодировки UTF-8 (\_UTF8).
...
<sup>1</sup> Начиная с [!INCLUDE[sql-server-2019](../../includes/sssql19-md.md)] CTP 2.3. [!INCLUDE[sql-server-2019](../../includes/sssql19-md.md)] В CTP 3.0 параметры сортировки **UTF8_BIN2** заменены на **Latin1_General_100_BIN2_UTF8**.        
<sup>2</sup> Начиная с [!INCLUDE[sql-server-2019](../../includes/sssql19-md.md)] CTP 2.3.    
...
В [!INCLUDE[sql-server-2019](../../includes/sssql19-md.md)] поддержка дополнительных символов распространяется на типы данных **char** и **varchar** в новых параметрах сортировки для UTF-8 ([\_UTF8](#utf8)). Эти типы данных также способны представлять полный диапазон символов Юникода.   
...
## <a name="japanese-collations-added-in--sssql17-md"></a><a name="Japanese_Collations"></a> Параметры сортировки для японского языка, добавленные в [!INCLUDE [sssql17-md](../../includes/sssql17-md.md)]
 
Начиная с версии [!INCLUDE [sssql17-md](../../includes/sssql17-md.md)] поддерживаются новые семейства параметров сортировки для японского языка с перестановками различных параметров (\_CS, \_AS, \_KS, \_WS и \_VSS). 
...
Консорциум Юникода назначает каждому символу уникальную кодовую точку, лежащую в диапазоне от 000000 до 10FFFF. В [!INCLUDE[sql-server-2019](../../includes/sssql19-md.md)] кодировки UTF-8 и UTF-16 могут представлять полный диапазон.    
