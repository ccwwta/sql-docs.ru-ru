...
|external_pool_id|**int**|**Область применения**: [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] и более поздних версий.<br /><br /> ИДЕНТИФИКАТОР внешнего пула ресурсов, который используется этой группой рабочей нагрузки.|  
