---
description: Динамические административные представления регулятора ресурсов (Transact-SQL)
title: Динамические административные представления с Resource Governorми (Transact-SQL) | Документация Майкрософт
ms.custom: ''
ms.date: 10/28/2018
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]
  ...
  Этот раздел содержит следующие динамические административные представления для регулятора ресурсов.  
