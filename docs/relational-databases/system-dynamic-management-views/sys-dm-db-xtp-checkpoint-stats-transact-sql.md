...
## <a name="sssql16-md-and-later"></a>[!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] и более поздних версий  
 В следующей таблице описаны столбцы в `sys.dm_db_xtp_checkpoint_stats` , начиная с **[!INCLUDE[sssql16-md](../../includes/sssql16-md.md)]** .  
