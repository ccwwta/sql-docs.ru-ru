...
|PAGELATCH_UP |Имеет место, когда задача ожидает кратковременной блокировки буфера, находящегося не в состоянии запроса ввода-вывода. Запрос на кратковременную блокировку производится в режиме обновления. Обычно этот тип ожидания может наблюдаться, когда системная страница (буфер), например PFS, GAM, SGAM блокируется. Устранение неполадок в обычном сценарии см. в статье [уменьшение количества выделений памяти в базе данных SQL Server tempdb](/troubleshoot/sql/performance/recommendations-reduce-allocation-contention).| 
