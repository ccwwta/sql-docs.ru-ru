...
##  <a name="sssql16-md-and-later"></a><a name="bkmk_2016"></a> [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] и более поздние версии  
 В следующей таблице описаны столбцы `sys.dm_db_xtp_checkpoint_files` , начиная с **[!INCLUDE[sssql16-md](../../includes/sssql16-md.md)]** .  
