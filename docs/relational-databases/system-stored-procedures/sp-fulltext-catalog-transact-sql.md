 ...
 **\@ путь** допустим только при создании *действия* .  Для действий, отличных от **CREATE** (**останавливаться**, **REBUILD** и т. д.), **\@ путь** должен иметь значение null или быть пропущен.  
