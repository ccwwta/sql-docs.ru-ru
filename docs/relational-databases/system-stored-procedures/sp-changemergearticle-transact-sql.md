...
||**false**|Репликация инструкций DELETE не выполняется.<br /><br />  **\* \* \* Важность \*** параметра delete_tracking **значение false** приводит к неконвергенции, а удаленные строки необходимо удалить вручную.|  
