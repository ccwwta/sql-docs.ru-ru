...
title: sp_query_store_flush_db (Transact-SQL) | Документация Майкрософт
ms.custom: ''
ms.date: 03/24/2017
ms.prod: sql
...
## <a name="examples"></a>Примеры  
 В следующем примере выполняется сброс части данных хранилища запросов, хранящихся в памяти, на диск.  
