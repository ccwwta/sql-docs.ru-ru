...
|**enabled_for_synmgr**|**int**|Можно ли синхронизировать подписку с помощью [!INCLUDE[msCoName](../../includes/msconame-md.md)] диспетчера синхронизации.|  
|**GUID подписки**|**двоичный (16)**|Глобальный идентификатор версии подписки в публикации.|  
