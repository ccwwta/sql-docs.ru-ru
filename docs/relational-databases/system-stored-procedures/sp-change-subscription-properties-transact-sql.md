...
||**0**|Для веб-синхронизации используется обычная проверка подлинности.<br /><br /> Примечание. для веб-синхронизации необходимо подключение TLS к веб-серверу.|  
