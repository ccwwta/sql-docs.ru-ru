---
description: Хранимые процедуры ядра СУБД (Transact-SQL)
...
:::row:::
    :::column:::
        ...
        [sp_createstats, хранимая процедура](../../relational-databases/system-stored-procedures/sp-createstats-transact-sql.md)
        ...
        [процедура sp_depends](../../relational-databases/system-stored-procedures/sp-depends-transact-sql.md)
        ...
        [хранимая процедура sp_droptype](../../relational-databases/system-stored-procedures/sp-droptype-transact-sql.md)
    ...
    :::column:::
        ...
        [хранимая процедура sp_helpindex](../../relational-databases/system-stored-procedures/sp-helpindex-transact-sql.md)
        ...
        [хранимая процедура sp_unbindefault](../../relational-databases/system-stored-procedures/sp-unbindefault-transact-sql.md)
