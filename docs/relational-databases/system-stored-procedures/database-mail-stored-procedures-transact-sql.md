---
description: Хранимые процедуры Database Mail (Transact-SQL)
title: Database Mail хранимых процедур (Transact-SQL) | Документация Майкрософт
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
:::row:::
    :::column:::
        [хранимая процедура sp_send_dbmail](../../relational-databases/system-stored-procedures/sp-send-dbmail-transact-sql.md)
    ...
    :::column-end:::
    :::column:::
        [sysmail_help_configure_sp, хранимая процедура](../../relational-databases/system-stored-procedures/sysmail-help-configure-sp-transact-sql.md)
        ...
        [sysmail_help_profile_sp, хранимая процедура](../../relational-databases/system-stored-procedures/sysmail-help-profile-sp-transact-sql.md)
        ...
        [sysmail_update_profile_sp, хранимая процедура](../../relational-databases/system-stored-procedures/sysmail-update-profile-sp-transact-sql.md)
