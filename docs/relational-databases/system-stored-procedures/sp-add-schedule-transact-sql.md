...
|**128**|Запуск при простое компьютера (не поддерживается в [управляемый экземпляр Azure SQL](/azure/sql-database/sql-database-managed-instance-transact-sql-information#sql-server-agent)) |  
