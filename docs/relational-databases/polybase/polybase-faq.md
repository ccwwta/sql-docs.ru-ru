...
В следующей таблице перечислены возможности PolyBase, доступные в изолированном экземпляре [!INCLUDE[sssql19](../../includes/sssql19-md.md)] и в [!INCLUDE[sssql19](../../includes/sssql19-md.md)], размещенном в кластере больших данных.
