---
description: Доставка моментального снимка через FTP
...
ms.locfileid: "99076722"
---
# <a name="deliver-a-snapshot-through-ftp"></a>Доставка моментального снимка через FTP
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sqlserver.md)]
  В этом разделе описывается доставка моментального снимка по протоколу FTP в [!INCLUDE[ssnoversion](../../../includes/ssnoversion-md.md)] с помощью среды [!INCLUDE[ssManStudioFull](../../../includes/ssmanstudiofull-md.md)] или [!INCLUDE[tsql](../../../includes/tsql-md.md)].  
