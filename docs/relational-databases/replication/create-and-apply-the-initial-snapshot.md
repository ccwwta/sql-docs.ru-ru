...
description: Сведения о том, как создать и применить исходный моментальный снимок в SQL Server с помощью SQL Server Management Studio, Transact-SQL или объектов Replication Management Objects.
ms.custom: ''
ms.date: 11/20/2018
ms.prod: sql
