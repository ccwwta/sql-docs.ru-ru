...
- [!INCLUDE [sssql19-md](../../../includes/sssql19-md.md)] или более поздней версии
...
## <a name="roles-and-responsibilities-when-configuring-attestation-with-hgs"></a>Роли и обязанности при настройке аттестации с помощью HGS
