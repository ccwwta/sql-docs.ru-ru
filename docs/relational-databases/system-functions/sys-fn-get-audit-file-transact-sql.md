...
| connection_id | Идентификатор GUID | Область **применения**: база данных SQL Azure и SQL управляемый экземпляр<br /><br /> Идентификатор соединения на сервере |
