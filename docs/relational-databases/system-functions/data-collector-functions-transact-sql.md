---
description: Функции сборщика данных (Transact-SQL)
title: Функции сборщика данных (Transact-SQL) | Документация Майкрософт
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
...
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]
 ...
 В следующей таблице приводится список функций, которые использует сборщик данных.  
