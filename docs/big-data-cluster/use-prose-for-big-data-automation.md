...
В зависимости от сложности файла для определения необходимых параметров может потребоваться несколько итераций.
