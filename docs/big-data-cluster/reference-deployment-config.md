---
title: Файл конфигурации развертывания
titleSuffix: SQL Server Big Data Clusters
description: Сведения о файле JSON, описывающем структуру файла конфигурации развертывания кластера больших данных SQL Server 2019.
