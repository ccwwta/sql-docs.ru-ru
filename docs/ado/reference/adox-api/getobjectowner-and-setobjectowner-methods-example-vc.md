---
description: Примеры методов GetObjectOwner и SetObjectOwner (Visual C++)
title: Примеры методов примеры методов getobjectowner и SetObjectOwner (Visual c++) | Документация Майкрософт
ms.prod: sql
