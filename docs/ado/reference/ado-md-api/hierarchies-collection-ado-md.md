...
ms.locfileid: "100054619"
---
# <a name="hierarchies-collection-ado-md"></a>Коллекция Hierarchies (многомерные объекты ADO)
Содержит набор объектов [Hierarchy](./hierarchy-object-ado-md.md) из измерения.  
...
-   [Свойства, методы и события](./hierarchies-collection-properties-methods-and-events.md)  
