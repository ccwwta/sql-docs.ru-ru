---
description: Примеры свойств ActualSize и DefinedSize (Visual Basic)
title: Примеры свойств ActualSize и DefinedSize (Visual Basic) | Документация Майкрософт
ms.prod: sql
