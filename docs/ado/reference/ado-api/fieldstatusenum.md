...
|**adFieldPendingChange**|0x40000|Указывает, что поле было удалено, затем повторно Добавлено, возможно, с другим типом данных или что значение поля, которое ранее имело состояние **адфиелдок** , изменилось. Последняя форма поля изменит коллекцию [Fields](./fields-collection-ado.md) после вызова метода [Update](./update-method.md) .|  
