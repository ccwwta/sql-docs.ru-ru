...
-   Hexadecimal-The шестнадцатеричное представление номера полной ошибки. Код устройства Windows находится в четвертой цифре. Код устройства для номеров ошибок ADO — *это*. Например: 0x800 ***A** _0E7B.  
  
> [!NOTE]
>  OLE DB ошибки могут передаваться в приложение ADO. Как правило, их можно идентифицировать с помощью кода оборудования Windows _4 *. Например, 0x800 * * * 4* *_.  
  
|Константа|Значение|Описание|  
|--------------|-----------|-----------------|  
|_ *адеррбаундтокомманд**|3707-2146824581 0x800A0E7B|Невозможно изменить свойство **ActiveConnection** объекта **Recordset** , который имеет объект **Command** в качестве источника.|  
