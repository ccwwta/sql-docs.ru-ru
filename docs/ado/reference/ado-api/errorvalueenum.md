...
-   Hexadecimal-The шестнадцатеричное представление номера полной ошибки. Код устройства Windows находится в четвертой цифре. Код устройства для номеров ошибок ADO — *это*. Например: 0x800 ***A*** 0E7B.  
