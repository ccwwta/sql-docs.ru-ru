...
В этом примере используются свойства [примеры absolutepage](./absolutepage-property-ado.md), [PageCount](./pagecount-property-ado.md)и [pageSize](./pagesize-property-ado.md) для вывода имен и дат найма из таблицы ***Employee** _, пять записей за раз.  
