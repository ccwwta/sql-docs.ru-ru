---
description: Пример свойств ActiveConnection, CommandText, CommandTimeout, CommandType, Size и Direction (JScript)
title: Пример свойств хранимой процедуры (JScript) | Документация Майкрософт
ms.prod: sql
