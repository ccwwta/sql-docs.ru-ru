...
ms.locfileid: "99170847"
---
# <a name="maxrecords-property-example-vc"></a>Пример свойства MaxRecords (Visual C++)
В этом примере свойство [maxRecords](./maxrecords-property-ado.md) используется для открытия [набора записей](./recordset-object-ado.md) , содержащего 10 наиболее дорогих заголовков в таблице ***titles** _.  
