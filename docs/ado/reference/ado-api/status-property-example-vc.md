---
description: Пример свойства Status (Visual C++)
title: Пример свойства Status (Visual c++) | Документация Майкрософт
ms.prod: sql
...
ms.locfileid: "100040404"
---
# <a name="status-property-example-vc"></a>Пример свойства Status (Visual C++)
