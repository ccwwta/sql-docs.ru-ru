---
title: Развертывание проекта служб SSIS с помощью SQL Server Management Studio
description: Развертывание проекта служб SSIS с помощью SQL Server Management Studio (SSMS)
ms.topic: quickstart
ms.prod: sql
...
## <a name="authentication-methods-for-deployment"></a>Методы проверки подлинности для развертывания
...
2. В диалоговом окне **Соединение с сервером** введите следующие данные:
   ...
   | **Аутентификация** | Проверка подлинности SQL Server | Используйте проверку подлинности SQL Server для подключения к SQL Server или к базе данных SQL Azure. См. раздел [Методы проверки подлинности для развертывания](#authentication-methods-for-deployment) в этой статье. |
...
3.  На странице **Выбор назначения** выберите назначение для проекта.
    ...
    -   Предоставьте сведения о проверке подлинности и выберите **Подключиться**. См. раздел [Методы проверки подлинности для развертывания](#authentication-methods-for-deployment) в этой статье.
