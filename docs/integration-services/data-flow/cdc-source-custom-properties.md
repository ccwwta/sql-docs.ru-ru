...
|-------------------|---------------|-----------------|  
|Соединение|Соединение ADO.Net|Соединение ADO.NET с базой данных CDC [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] для доступа к таблицам изменений.|  
