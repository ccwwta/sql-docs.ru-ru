...
*OR ALTER*
**Область применения**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ([!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] с пакетом обновления 1 (SP1) и выше), а также [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]

Условно изменяет функцию только в том случае, если она уже существует.

> [!NOTE]
> Необязательный синтаксис [OR ALTER] для среды CLR доступен, начиная с [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] с пакетом обновления 1 (SP1) с накопительным пакетом обновления 1 (CU1).
