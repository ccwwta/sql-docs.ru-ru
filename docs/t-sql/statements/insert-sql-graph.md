...
description: Сведения о синтаксисе, разрешениях и аргументах инструкции INSERT, которая добавляет одну или несколько строк в узел SQL Graph или в граничную таблицу в SQL Server.
ms.date: 05/12/2017
ms.prod: sql
