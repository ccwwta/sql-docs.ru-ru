---
description: Новые функции графического пользовательского интерфейса в SSMA для MySQL (MySQLToSQL)
...
Эта функция позволяет выбрать один из двух предопределенных раскладок Windows или создать собственный макет. Для доступа к подменю макет в меню Вид выберите пункт макеты. Здесь можно выбрать один из существующих макетов, добавить текущий макет или управлять макетами.  
