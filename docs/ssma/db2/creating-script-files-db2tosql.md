---
description: Создание файлов скриптов (DB2ToSQL)
title: Создание файлов скриптов (DB2ToSQL) | Документация Майкрософт
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "100081515"
---
# <a name="creating-script-files-db2tosql"></a>Создание файлов скриптов (DB2ToSQL)
...
## <a name="configuring-db2-console-settings"></a>Настройка параметров консоли DB2  
...
7.  **Операция завершения:** При выполнении средней операции, если пользователь хочет прерывать операцию, можно использовать сочетание клавиш **CTRL + C** . SSMA для консоли DB2 будет ждать завершения операции и завершит выполнение консоли.  
...
Например, типичная миграция данных для определенной таблицы в базе данных DB2 соответствует иерархии: schema- &gt; Table.  
...
Полный список команд сценария можно найти в статьях [выполнение консоли SSMA &#40;DB2ToSQL&#41;](../../ssma/db2/executing-the-ssma-console-db2tosql.md)  
...
Следующим шагом в работе консоли является [Создание файлов значений переменных &#40;DB2ToSQL&#41;](../../ssma/db2/creating-variable-value-files-db2tosql.md).  
