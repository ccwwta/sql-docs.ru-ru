...
|Полное|Приведение к фиксированной длине|
...
|По умолчанию|Простое преобразование|
|Optimistic|Простое преобразование|
|Полное|Пустая строка как нулевое число|
...
|Полное|Включить в оболочку функцию ISNULL|
...
|По умолчанию|Сохраняет текущий синтаксис|
|Optimistic|Сохраняет текущий синтаксис|
|Полное|Замена всех строковых выражений на пробел|
...
|По умолчанию|Преобразование и пометка с предупреждением|
|Optimistic|Простое преобразование|
|Полное|Преобразовать и исправить|
...
|По умолчанию|Простое преобразование|
|Optimistic|Простое преобразование|
|Полное|Принимать значения NULL|
...
|Полное|Создать новую переменную|
