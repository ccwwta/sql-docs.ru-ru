...
description: Сведения о первичных выражениях XQuery, включающих литералы, ссылки на переменные, выражения элементов контекста, конструкторы и вызовы функций.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.prod_service: sql
