---
description: Создание настраиваемого рабочего процесса (службы Master Data Services)
title: Создание настраиваемого рабочего процесса
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.prod_service: mds
