---
title: Конечный элемент таблицы элементов
description: Используйте промежуточную таблицу конечных элементов в базе данных Master Data Services для создания, обновления, деактивации и удаления конечных элементов.
ms.custom: ''
ms.date: 04/01/2016
ms.prod: sql
ms.prod_service: mds
