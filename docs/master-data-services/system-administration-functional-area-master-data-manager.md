---
description: Функциональная область системного администрирования (диспетчер основных данных)
...
## <a name="model"></a>Моделирование  
 ...
 [Создание пакета развертывания модели с помощью мастера](../master-data-services/create-a-model-deployment-package-by-using-the-wizard.md)  
