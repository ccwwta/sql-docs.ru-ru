---
description: Функциональная область управления версиями (диспетчер основных данных)
title: Функциональная область управления версиями
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
...
## <a name="versions"></a>Версии  
 ...
 [Удаление версии (службы Master Data Services)](../master-data-services/delete-a-version-master-data-services.md)  
