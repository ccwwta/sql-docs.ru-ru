...
description: Узнайте, как создать представление подписки для экспорта Master Data Services данных в системы подписчиков, которые создают представление данных.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
...
|Уровень|Указывает количество уровней в представлении. Используется только для форматов представлений "Явный" или "Производный".|  
