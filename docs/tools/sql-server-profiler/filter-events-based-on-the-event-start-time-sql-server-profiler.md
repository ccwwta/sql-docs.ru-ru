...
description: Фильтруйте события по времени начала во время трассировки. Узнайте, как настроить фильтр по времени начала события в SQL Server Profiler.
ms.prod: sql
