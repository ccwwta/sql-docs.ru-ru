...
description: Получите справку по устранению неполадок путем воспроизведения файлов трассировки в SQL Server Profiler. Узнайте о возможностях и вариантах воспроизведения.
ms.prod: sql
