...
description: Служебная программа profiler запускает средство SQL Server Profiler. Дополнительные аргументы позволяют управлять способом запуска приложения.
