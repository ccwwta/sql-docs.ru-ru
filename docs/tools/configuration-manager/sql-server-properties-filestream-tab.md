...
description: Узнайте, как использовать вкладку FILESTREAM диалогового окна "Свойства SQL Server", чтобы включить FILESTREAM для установки SQL Server 2019.
