...
description: Изучите параметр user options. Узнайте, как он изменяет значения по умолчанию параметров обработки запроса, задаваемых SQL Server для рабочих сеансов пользователя.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
