...
description: Изучите параметр remote query timeout. Узнайте, как с его помощью можно задать время выполнения (в секундах) удаленной операции перед тем, как истечет время ожидания SQL Server.
ms.custom: ''
ms.date: 03/08/2017
ms.prod: sql
