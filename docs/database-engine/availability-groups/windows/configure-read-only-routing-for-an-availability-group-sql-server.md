...
Маршрутизация только для чтения доступна в [!INCLUDE[sssql16-md](../../../includes/sssql16-md.md)] и более поздних версиях.
