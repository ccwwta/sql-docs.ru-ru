...
ms.locfileid: "100343905"
---
# <a name="administration-of-an-availability-group"></a>Администрирование группы доступности
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sqlserver.md)]
 Управление существующей группой доступности AlwaysOn в [!INCLUDE[ssnoversion](../../../includes/ssnoversion-md.md)] включает в себя одну или несколько следующих задач:  
