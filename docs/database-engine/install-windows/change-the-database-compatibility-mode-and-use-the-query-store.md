...
В [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] и выше некоторые изменения становятся доступны только после того, как изменится [уровень совместимости базы данных](../../t-sql/statements/alter-database-transact-sql-compatibility-level.md). Это сделано по нескольким причинам:  
