---
description: Метод setDate (int, java.sql.Date, java.util.Calendar)
title: Метод setDate для объектов Date и Calendar (int) | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
