---
description: Метод supportsCatalogsInDataManipulation (SQLServerDatabaseMetaData)
title: Метод supportsCatalogsInDataManipulation | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
