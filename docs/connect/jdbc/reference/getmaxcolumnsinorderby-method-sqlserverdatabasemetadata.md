---
description: Метод getMaxColumnsInOrderBy (SQLServerDatabaseMetaData)
title: Метод getMaxColumnsInOrderBy (SQLServerDatabaseMetaData) | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 Этот метод getMaxColumnsInOrderBy задается с помощью метода getMaxColumnsInOrderBy в интерфейсе java.sql.DatabaseMetaData.  
