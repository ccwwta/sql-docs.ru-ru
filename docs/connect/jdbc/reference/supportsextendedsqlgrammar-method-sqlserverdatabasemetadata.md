---
description: Метод supportsExtendedSQLGrammar (SQLServerDatabaseMetaData)
title: Метод supportsExtendedSQLGrammar (SQLServerDatabaseMetaData) | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 Этот метод supportsExtendedSQLGrammer задается с помощью метода supportsExtendedSQLGrammer в интерфейсе java.sql.DatabaseMetaData.  
