...
description: Системные свойства являются глобальными для базы данных сервера отчетов. Многие из этих свойств можно считывать или изменять с помощью методов веб-службы.
ms.date: 03/06/2017
