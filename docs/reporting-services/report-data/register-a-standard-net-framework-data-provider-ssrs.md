...
description: Регистрация стандартного поставщика данных .NET Framework для использования стороннего поставщика данных .NET Framework для получения набора данных отчета Reporting Services.
ms.date: 05/24/2018
