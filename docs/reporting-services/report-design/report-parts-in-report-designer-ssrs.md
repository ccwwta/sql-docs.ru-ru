---
title: Части отчетов в конструкторе отчетов | Документация Майкрософт
description: Публикация элементов отчета с разбивкой на страницы на сервере отчетов или сайте SharePoint по-отдельности, чтобы вы и другие пользователи могли использовать их в других отчетах в построителе отчетов.
ms.date: 05/30/2017
