---
title: Функция Min (построитель отчетов) | Документация Майкрософт
description: Узнайте о функции Min, которая возвращает минимальное значение всех числовых значений, отличных от NULL, заданных выражением в построителе отчетов.
ms.date: 03/07/2017
...
ms.locfileid: "98595999"
---
# <a name="report-builder-functions---min-function"></a>Функции построителя отчетов — функция Min
