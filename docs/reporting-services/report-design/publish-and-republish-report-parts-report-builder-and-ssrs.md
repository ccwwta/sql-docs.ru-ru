---
title: Публикация и повторная публикация элементов отчетов (построитель отчетов) | Документация Майкрософт
description: Сведения о том, как опубликовать элемент отчета с измененными метаданными с параметрами по умолчанию в расположении по умолчанию в построителе отчетов.
ms.date: 03/01/2017
