---
title: Экспорт отчетов (построитель отчетов) | Документация Майкрософт
description: Можно экспортировать отчет Reporting Services в файл другого формата, например PowerPoint или PDF, используя построитель отчетов, конструктор отчетов или сервер отчетов.
ms.date: 05/30/2017
...
## <a name="to-export-a-report-from-report-builder"></a><a name="bkmk_export_from_rb"></a> Экспорт отчета из построителя отчетов

1.  Выполните или просмотрите отчет.  
  
2.  На ленте нажмите кнопку **Экспорт**.  
  
     ![Экспорт из построителя отчетов](../../reporting-services/report-builder/media/ssrb-export.png "Экспорт из построителя отчетов")  
...
##  <a name="to-export-a-report-from-the-ssrsnoversion-web-portal"></a><a name="bkmk_export_from_rm"></a> Экспорт отчета с веб-портала служб [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]  
...
5.  Щелкните **Экспорт**. Появится диалоговое окно с вопросом о том, что нужно сделать с файлом: открыть или сохранить.  
...
##  <a name="to-export-a-report-from-a-sharepoint-library"></a><a name="bkmk_export_from_sharepoint"></a> Экспорт отчета из библиотеки SharePoint  
...
##  <a name="formats-you-can-export-while-viewing-reports"></a><a name="ExportFormats"></a> Форматы файлов, в которые можно экспортировать отчеты при просмотре  
...
##  <a name="generating-data-feeds-from-a-report"></a><a name="GeneratingDataFeedsFromReport"></a> Формирование веб-каналов данных из отчета  
...
##  <a name="troubleshooting-exported-reports"></a><a name="Troubleshooting"></a> Устранение неполадок, связанных с экспортированными отчетами  
...
##  <a name="other-ways-of-exporting-reports"></a><a name="OtherWaysExportingReports"></a> Другие методы экспорта отчетов  
