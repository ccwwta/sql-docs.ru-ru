...
description: В этом учебнике вы создадите круговую диаграмму в отчете Reporting Services с разбивкой на страницы в построителе отчетов. Затем вы добавите значения в процентах и измените круговую диаграмму.
ms.date: 05/30/2017
...
ms.locfileid: "100070554"
---
# <a name="tutorial-create-a-quick-chart-report-offline-report-builder"></a>Руководство по Создание стандартного отчета с диаграммой в автономном режиме (построитель отчетов)
...
##  <a name="two-ways-to-do-this-tutorial"></a><a name="TwoWays"></a> Два способа выполнить задания этого учебника  
...
##  <a name="after-you-run-the-wizard"></a><a name="AfterWizard"></a> После завершения работы мастера  
...
##  <a name="whats-next"></a><a name="WhatsNext"></a> Дальнейшая работа  
