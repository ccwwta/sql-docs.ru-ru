---
title: Определение версии схемы определения отчета | Документация Майкрософт
description: Узнайте, как определить версию языка определения отчетов (RDL) для схемы файла определения отчета.
ms.date: 06/06/2019
