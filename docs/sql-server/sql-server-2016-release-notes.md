...
![Снимок экрана горизонтальной полосы.](media/horizontal-bar.png)
...
![Еще один снимок экрана с горизонтальной полосой.](media/horizontal-bar.png)
