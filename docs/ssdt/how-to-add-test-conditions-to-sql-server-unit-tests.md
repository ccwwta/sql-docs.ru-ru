...
description: Сведения о добавлении условий теста в модульный тест SQL Server. Описание использования конструктора модульных тестов SQL Server для этой задачи.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
